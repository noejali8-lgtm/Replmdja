  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between mb-12">
        <button className="p-2 -ml-2 text-muted-foreground hover:text-foreground" data-testid="button-menu">
            ...
            {showGithubTooltip && (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-foreground leading-tight mb-1">Import from GitHub</p>
                  <p className="text-xs text-muted-foreground leading-snug">Bring in your existing repositories.</p>
                </div>
                <div 
                  className="absolute -top-2 right-3 w-4 h-4 bg-card border-t border-l border-border transform rotate-45"
                />
              </motion.div>
            )}
          </AnimatePresence>
