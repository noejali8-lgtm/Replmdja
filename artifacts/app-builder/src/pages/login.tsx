      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="px-6 pt-5 pb-2 flex flex-col gap-2.5">
          ...
          <button
            ...
            className="w-full h-11 rounded-xl bg-white hover:bg-gray-100 border border-white/[0.10] text-gray-800 text-sm font-medium transition-colors flex items-center justify-center gap-2.5">
            <GoogleIcon size={18} />
